...
| dr_mp3 | MIT-0 OR Unlicense | `include/dr_mp3.h` | `third-party compliance bundle` |
...
The machine-readable inventory is `third_party/compliance-manifest.json`; the
build packages the full compliance bundle (licenses, notices, and bundled
sources) at `out/compliance/third-party`, staged into the image at
`system/licenses/third-party`.
