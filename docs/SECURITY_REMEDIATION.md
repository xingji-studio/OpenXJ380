...
- Vendored BusyBox/libvterm dependency findings were resolved here by moving those components into the private XJ380 distribution repo; their version inventory, upgrade selection and compatibility testing continue there. No dependency CVE is marked fixed in this tree.
