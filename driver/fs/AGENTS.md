...
- Do not change path tokenization or alias behavior without checking shell, browser, xbps, and image layout. (Busybox alias registration lives in the private XJ380 kernel overlay, not here.)
